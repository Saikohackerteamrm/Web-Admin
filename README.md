...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/Web-Admin/blob/main/20250805_115008.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/Web-Admin
    $ cd Web-Admin
    $ python RM.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/Web-Admin && cd Web-Admin && python RM.py
 ### Hi there 👋
